...
- scene: 画面骤静：猫咪挂着眼泪沿注意力轨道从右上角缓缓降落到屏幕中央，举牌「陪我慢慢眨 2 下」；观众眨眼（眨眼波形恢复跳动），他立刻擦泪回升——字幕「赶在伤害累积之前」
- voiceover: ""
- duration: 10s
- transition_in: blur-crossfade
- status: animated
- src: compositions/frames/04-cat-steps.html
- type: product_intro
- persuasion: Show-don't-tell proof（真提醒，非计时器）
- beat: 被看见 → 安心
- blueprint: device-surface-showcase (Adapt)
- focal: assets/heterochromia-cat-idle.png
- asset_candidates: assets/heterochromia-cat-idle.png — 立绘; assets/cat-tear.png — 泪流泪滴贴片
- roles: heterochromia-cat-idle = cutout（降落主体）· cat-tear = supporting（泪流/泪滴）

narrativeRole: 产品第一次出手——25 秒不是弹窗，是他来了。眨 2 下 = 重新镀上保护膜；眨满两次他才安心走开。
keyMessage: 25 秒没眨眼，他带着眼泪来陪你眨 2 下。
字幕文案: ① 25 秒 · 猫咪出手的时机 ② 眨一次眼，就是重新镀上一层保护膜 ③ 眨满 2 下，他才安心走开

Adapt：不适用设备框——以「注意力轨道」为 held surface（右上→中央的虚线轨道即舞台），保留屏幕循环的 stepwise 节奏：降落→举牌→回应→回升。
Scene 1 (0.0–1.6s): 画面骤静回暖（tile 暖沙底自边缘渗入）；右上角虚线轨道 SVG self-draw；猫咪挂泪流出现于轨道顶端（`spring-pop-entrance` 平滑落位）。
Scene 2 (1.6–4.6s): 猫咪沿轨道缓缓降落（多段 translateY 长尾，泪滴 finite 两坠）；字幕①「25 秒 · 猫咪出手的时机」per-word 落。
Scene 3 (4.6–6.8s): 小牌「陪我慢慢眨 2 下」平滑举出；字幕②「眨一次眼，就是重新镀上一层保护膜」word-swap 接替。
Scene 4 (6.8–8.6s): 回应拍：底部波形恢复一记跳动，猫咪擦泪（tear 贴片淡出）沿轨道回升。
...
- focal: 两列隐私对照卡
- asset_candidates: assets/heterochromia-cat-idle.png — 猫咪立绘（守在两列之间）
- roles: heterochromia-cat-idle = supporting（两卡之间守望）
...
Scene 4 (6.6–8.6s): 内外边 pill 徽记平滑点出；猫咪立绘自两卡间隙步入守望位（小位移，不抢戏）。
Scene 5 (8.6–10.0s): 底行「所有检测都在本机完成——不上传、不保存」落；hold。

## Frame 6 — Look Me

- scene: 墨青底翻雾白：巨大「Look Me · 看看我」字标落位，猫咪立绘拍手 sprite 彩蛋，副题「泪膜只能撑 10 秒——有人替你记着」+ 三平台下载按钮
- voiceover: ""
- duration: 10s
- transition_in: zoom-through
- status: animated
...
- roles: heterochromia-cat-idle = cutout（字标旁）· clap-sprite = 彩蛋叠层
...
Scene 2 (1.6–3.2s): 「看看我」append 落位；✱ coral spike 点睛平滑点出；猫咪立绘于字标右侧 spring-pop 落位 + 拍手 sprite 一轮。
