...
def frame1_hook(st, pid):  # 10s
  ...
  <div id="root" data-composition-id="01-hook" data-width="1920" data-height="1080" data-duration="10">
    ...
    <div id="01-hook-pet" class="clip pet" data-start="5.6" data-duration="4.4" data-track-index="5">
      <img src="assets/kanshan-distance-break.png" alt="">
    </div>
...
format: 1920x1080
duration: 45s
message: "Look Me · {st['name']}风格样片——泪膜只能撑 10 秒，刘看山替你记着"
...
- scene: {st['name']}风格开场：径向光斑衬底，「泪膜只能撑 10 秒」display 字落，看山登场
- duration: 10s
- transition_in: cut
- status: outline
...
for pid, st in S.items():
    ...
    shutil.copy(f'{ASSETS_SRC}/kanshan-distance-break.png', f'{proj}/assets/')
    # storyboard + frames
