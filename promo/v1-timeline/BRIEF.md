...
Look Me（看看我）官方宣传视频，三个平行版本中的「一天的时间轴」版。用户委托："做 3 个版本，然后给我看"——autonomous 信号，直接交付成品 MP4。产品是猫咪伙伴 IP 的桌面护眼陪伴应用：透明置顶小宠物常驻桌面，本地摄像头视觉检测（不上传），提醒眨眼、远眺（20-20-20）、起身。调性：安静、温和、不打扰——"只在该出现的时候出现"。官网叙事签名是贯穿全页的 Timeline 脊柱（09:00 → 10:24 → 14:07 → 18:30 → 现在），本版本复刻这一结构作为视频主线。
