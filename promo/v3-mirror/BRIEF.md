...
Look Me（看看我）官方宣传视频，三个平行版本中的「镜像陪伴·情感向」版。用户委托："做 3 个版本，然后给我看"——autonomous 信号，直接交付成品 MP4。产品是知乎刘看山 IP 的桌面护眼陪伴应用：透明置顶小宠物常驻桌面，本地摄像头视觉检测（不上传），提醒眨眼、远眺（20-20-20）、起身。调性：安静、温和、不打扰——"只在该出现的时候出现"。本版以官网「看山的陪伴」段落为主线：眨眼镜像、哈欠镜像、注意力轨道掉泪提醒、待机小剧场（拍手/坐下/转圈），结尾落在「他看得见你，但守口如瓶」的隐私承诺。
