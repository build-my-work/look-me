...
const CRY_IMAGE = new URL("assets/heterochromia-cat-cry.png", document.baseURI).toString();
const CLAP_SPRITE_IMAGE = new URL(
  "assets/heterochromia-cat-clap-sprite.png",
  document.baseURI,
).toString();
const SIT_SPRITE_IMAGE = new URL(
  "assets/heterochromia-cat-sit-sprite.png",
  document.baseURI,
).toString();
const SPIN_SPRITE_IMAGE = new URL(
  "assets/heterochromia-cat-spin-sprite.png",
  document.baseURI,
).toString();
const YAWN_SPRITE_IMAGE = new URL(
  "assets/heterochromia-cat-yawn-sprite.png",
  document.baseURI,
).toString();
const TEAR_IMAGE = new URL("assets/cat-tear.png", document.baseURI).toString();
      ...
      >
        <div className="coach-pet-shell">
          <div className="coach-pet-visual">
            ...
            />
            <span
              className="pet-sprite pet-sprite--yawn"
              style={{ backgroundImage: `url(${YAWN_SPRITE_IMAGE})` }}
              aria-hidden="true"
            />
            {displayedAttentionFrame.crying && (
              <img className="pet-state-image pet-state-image--cry" src={CRY_IMAGE} alt="" />
            )}
            {(faceMonitor.blinkCount > 0 || petBlinkDemo) && (
              <img
                className={petBlinkDemo ? "pet-blink pet-blink--demo" : "pet-blink"}
